...
export default function SalonSetupPage() {
  ...
  }, [locationSearch, mapboxAvailable, location.country_code, basic.country_code, locale, showToast, t]);
    ...
    try {
      ...
      const payload = {
        ...
        salon: {
          ...
          slug: normalizeSlug(basic.name.trim()),
        ...
        <div className="cc-container onboarding-page">
          <Card className="onboarding-success-card">
            ...
            <div className="onboarding-success-actions">
              ...
              <Button as={Link} to="/sa" variant="secondary">{t("onboarding.success.backSuperadmin", "Back to superadmin")}</Button>
            </div>
          </Card>
        </div>
  ...
  return (
    <PageShell
      title={t("onboarding.title", "Salon setup wizard")}
      subtitle={t("onboarding.subtitle", "Create the full salon structure in one flow.")}
      right={<Button as={Link} to="/sa" variant="ghost">{t("onboarding.backAdmin", "Back to superadmin")}</Button>}
    >
      <div className="cc-container onboarding-page">
                  ...
                  >
                    {countries.map((country) => (
                      <option key={country.code} value={country.code}>
                        {localizeCountryName(country, locale)}
                      </option>
                    ))}
                  </SelectInput>
                )}
